...
% all parameters needed to run the ENSO-MJO model for one setup
...
simutype=  3; % Type of model simulation
% simutype= 1: Crude Interranual Model
% simutype =2: Crude Intraseasonal Model
% simutype= 3: Complete TSS-GCM Model
